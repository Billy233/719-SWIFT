...
C_SRCS += \
../Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/arm_sin_cos_example_f32.c 

C_DEPS += \
./Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/arm_sin_cos_example_f32.d 

OBJS += \
./Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/arm_sin_cos_example_f32.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/%.o Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/%.su Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/%.cyclo: ../Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/%.c Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/subdir.mk
...
clean: clean-Middlewares-2f-CMSIS-2d-DSP-2f-1-2e-15-2e-0-2f-Examples-2f-ARM-2f-arm_sin_cos_example

clean-Middlewares-2f-CMSIS-2d-DSP-2f-1-2e-15-2e-0-2f-Examples-2f-ARM-2f-arm_sin_cos_example:
	-$(RM) ./Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/arm_sin_cos_example_f32.cyclo ./Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/arm_sin_cos_example_f32.d ./Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/arm_sin_cos_example_f32.o ./Middlewares/CMSIS-DSP/1.15.0/Examples/ARM/arm_sin_cos_example/arm_sin_cos_example_f32.su

.PHONY: clean-Middlewares-2f-CMSIS-2d-DSP-2f-1-2e-15-2e-0-2f-Examples-2f-ARM-2f-arm_sin_cos_example
